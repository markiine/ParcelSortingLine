...
namespace ParcelSorting
{
    public class Program
    {
        ...
        {
            Console.WriteLine("Hello World! Wasssaaa!");
        ...
        {
            // väikse algustähega kuna on lokaalne muutuja, töötab ainult siin all
            ...
            foreach (BoxSize box in boxSizes)
            {
                ...
                foreach (SortingLineParam sortingLine in box.SortingLineParams)
                {
                    ...
                    else if (sortingLine.LineWidth <= halfParcelDiagonal && sortingLine.LineWidth >= cornerDiagonal)
                    {
                        ...
                        var result = parcelFits ? "Sorting line width is " + sortingLine.LineWidth + " and it fits" : "It doesn't fir to the sorting line and needs to be wider";
                    ...
                    {
                        Console.WriteLine("It doesn't fir to the sorting line and needs to be wider", sortingLine.LineWidth);
                    }
